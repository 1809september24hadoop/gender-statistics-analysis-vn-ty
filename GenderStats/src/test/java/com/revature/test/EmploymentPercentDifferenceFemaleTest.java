...
public class EmploymentPercentDifferenceFemaleTest {
	...
	private String row = "\"Australia\",\"AUS\",\"Employers, female (% of female employment)\",\"SL.EMP.MPYR.FE.ZS\""
			+ ",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\""
			+ ",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\""
			+ ",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\""
	...
	@Before
	public void setUp() {
		EmploymentPercentDifferenceFemaleMapper mapper = new EmploymentPercentDifferenceFemaleMapper();
		mapDriver = new MapDriver<>();
		mapDriver.setMapper(mapper);
		
		EmploymentPercentDifferenceFemaleReducer reducer = new EmploymentPercentDifferenceFemaleReducer();
